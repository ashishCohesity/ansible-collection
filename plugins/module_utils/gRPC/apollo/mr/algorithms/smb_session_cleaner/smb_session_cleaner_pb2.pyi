...
class SmbSessionCleanerContextDataProto(_message.Message):
...
class SmbSessionCleanerInfoProto(_message.Message):
    __slots__ = ("is_active", "scribe_row_version_to_delete", "entity_ids")
    ...
    SCRIBE_ROW_VERSION_TO_DELETE_FIELD_NUMBER: _ClassVar[int]
    ENTITY_IDS_FIELD_NUMBER: _ClassVar[int]
    is_active: bool
    scribe_row_version_to_delete: int
    entity_ids: _containers.RepeatedCompositeFieldContainer[SmbSessionCleanerInfoProto.EntityIdInfo]
    def __init__(self, is_active: bool = ..., scribe_row_version_to_delete: _Optional[int] = ..., entity_ids: _Optional[_Iterable[_Union[SmbSessionCleanerInfoProto.EntityIdInfo, _Mapping]]] = ...) -> None: ...
