...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in bridge/ddw_portal/stub/magneto_proxy_grpc_service_pb2_grpc.py depends on'
...
class MagnetoProxyGRpcServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StartExternallyTriggeredBackup = channel.unary_unary(
                '/cohesity.bridge.ddw_portal.stub.MagnetoProxyGRpcService/StartExternallyTriggeredBackup',
        ...
        self.EndExternallyTriggeredBackup = channel.unary_unary(
                '/cohesity.bridge.ddw_portal.stub.MagnetoProxyGRpcService/EndExternallyTriggeredBackup',
        ...
        self.ExternallyTriggeredKeepAlive = channel.unary_unary(
                '/cohesity.bridge.ddw_portal.stub.MagnetoProxyGRpcService/ExternallyTriggeredKeepAlive',
...
class MagnetoProxyGRpcServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_MagnetoProxyGRpcServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cohesity.bridge.ddw_portal.stub.MagnetoProxyGRpcService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cohesity.bridge.ddw_portal.stub.MagnetoProxyGRpcService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class MagnetoProxyGRpcService(object):
    """Missing associated documentation comment in .proto file."""
