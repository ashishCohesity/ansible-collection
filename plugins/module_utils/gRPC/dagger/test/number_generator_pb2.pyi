...
class TaskType(_message.Message):
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        kNumberGenerator: _ClassVar[TaskType.Type]
        kTaskCount: _ClassVar[TaskType.Type]
    kUnknown: TaskType.Type
    kNumberGenerator: TaskType.Type
    kTaskCount: TaskType.Type
    def __init__(self) -> None: ...

class NumberGeneratorArg(_message.Message):
    __slots__ = ("range_start", "range_size")
    RANGE_START_FIELD_NUMBER: _ClassVar[int]
    RANGE_SIZE_FIELD_NUMBER: _ClassVar[int]
    range_start: int
    range_size: int
    def __init__(self, range_start: _Optional[int] = ..., range_size: _Optional[int] = ...) -> None: ...
...
class NumberGeneratorState(_message.Message):
