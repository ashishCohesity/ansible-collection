...
class CreateFileResult(_message.Message):
    __slots__ = ("greeting", "timestamp", "success", "message")
    ...
    success: bool
    message: str
    def __init__(self, greeting: _Optional[str] = ..., timestamp: _Optional[int] = ..., success: bool = ..., message: _Optional[str] = ...) -> None: ...
...
class ReadWriteResult(_message.Message):
