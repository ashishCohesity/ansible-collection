...
class ErrorType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    fNoError: _ClassVar[ErrorType]
    fFileNotExists: _ClassVar[ErrorType]
    fOther: _ClassVar[ErrorType]
fNoError: ErrorType
fFileNotExists: ErrorType
fOther: ErrorType
...
class CreateFileResponse(_message.Message):
    ...
    error: ErrorType
    def __init__(self, error: _Optional[_Union[ErrorType, str]] = ...) -> None: ...
