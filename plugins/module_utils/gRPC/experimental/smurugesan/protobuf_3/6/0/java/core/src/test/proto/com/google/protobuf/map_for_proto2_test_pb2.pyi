...
class TestMap(_message.Message):
    __slots__ = ("int32_to_int32_field", "int32_to_string_field", "int32_to_bytes_field", "int32_to_enum_field", "int32_to_message_field", "string_to_int32_field", "required_message_map")
    ...
    class MessageWithRequiredFields(_message.Message):
        __slots__ = ("value",)
        VALUE_FIELD_NUMBER: _ClassVar[int]
        value: int
        def __init__(self, value: _Optional[int] = ...) -> None: ...
    class RequiredMessageMapEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: TestMap.MessageWithRequiredFields
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[TestMap.MessageWithRequiredFields, _Mapping]] = ...) -> None: ...
    ...
    REQUIRED_MESSAGE_MAP_FIELD_NUMBER: _ClassVar[int]
...
class TestUnknownEnumValue(_message.Message):
    ...
    INT32_TO_INT32_FIELD_FIELD_NUMBER: _ClassVar[int]
    int32_to_int32_field: _containers.ScalarMap[int, int]
    def __init__(self, int32_to_int32_field: _Optional[_Mapping[int, int]] = ...) -> None: ...

class TestRecursiveMap(_message.Message):
    __slots__ = ("value", "recursive_map_field")
    class RecursiveMapFieldEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: TestRecursiveMap
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[TestRecursiveMap, _Mapping]] = ...) -> None: ...
    VALUE_FIELD_NUMBER: _ClassVar[int]
    RECURSIVE_MAP_FIELD_FIELD_NUMBER: _ClassVar[int]
    value: int
    recursive_map_field: _containers.MessageMap[int, TestRecursiveMap]
    def __init__(self, value: _Optional[int] = ..., recursive_map_field: _Optional[_Mapping[int, TestRecursiveMap]] = ...) -> None: ...
