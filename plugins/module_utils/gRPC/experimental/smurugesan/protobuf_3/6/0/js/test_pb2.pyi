...
class Int64Types(_message.Message):
    __slots__ = ("int64_normal", "int64_string", "int64_number")
    INT64_NORMAL_FIELD_NUMBER: _ClassVar[int]
    INT64_STRING_FIELD_NUMBER: _ClassVar[int]
    INT64_NUMBER_FIELD_NUMBER: _ClassVar[int]
    int64_normal: int
    int64_string: int
    int64_number: int
    def __init__(self, int64_normal: _Optional[int] = ..., int64_string: _Optional[int] = ..., int64_number: _Optional[int] = ...) -> None: ...
