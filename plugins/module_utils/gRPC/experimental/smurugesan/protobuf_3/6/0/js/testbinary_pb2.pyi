...
class MapEntryOptionalKeysStringKey(_message.Message):
    __slots__ = ("key", "value")
    KEY_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    key: str
...
class MapEntryOptionalKeysInt32Key(_message.Message):
    __slots__ = ("key", "value")
    KEY_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    key: int
...
class MapEntryOptionalKeysInt64Key(_message.Message):
    __slots__ = ("key", "value")
    KEY_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    key: int
...
class MapEntryOptionalKeysBoolKey(_message.Message):
    __slots__ = ("key", "value")
    KEY_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    key: bool
...
class TestMapFieldsOptionalKeys(_message.Message):
    __slots__ = ("map_string_string", "map_int32_string", "map_int64_string", "map_bool_string")
    MAP_STRING_STRING_FIELD_NUMBER: _ClassVar[int]
    MAP_INT32_STRING_FIELD_NUMBER: _ClassVar[int]
    MAP_INT64_STRING_FIELD_NUMBER: _ClassVar[int]
    MAP_BOOL_STRING_FIELD_NUMBER: _ClassVar[int]
    map_string_string: MapEntryOptionalKeysStringKey
    map_int32_string: MapEntryOptionalKeysInt32Key
    map_int64_string: MapEntryOptionalKeysInt64Key
    map_bool_string: MapEntryOptionalKeysBoolKey
    def __init__(self, map_string_string: _Optional[_Union[MapEntryOptionalKeysStringKey, _Mapping]] = ..., map_int32_string: _Optional[_Union[MapEntryOptionalKeysInt32Key, _Mapping]] = ..., map_int64_string: _Optional[_Union[MapEntryOptionalKeysInt64Key, _Mapping]] = ..., map_bool_string: _Optional[_Union[MapEntryOptionalKeysBoolKey, _Mapping]] = ...) -> None: ...
