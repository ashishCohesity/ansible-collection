...
class Message3(_message.Message):
    __slots__ = ("optional_int32", "optional_int64", "optional_uint32", "optional_uint64", "optional_sint32", "optional_sint64", "optional_fixed32", "optional_fixed64", "optional_sfixed32", "optional_sfixed64", "optional_float", "optional_double", "optional_bool", "optional_string", "optional_bytes", "optional_message", "optional_enum", "repeated_int32", "repeated_int64", "repeated_uint32", "repeated_uint64", "repeated_sint32", "repeated_sint64", "repeated_fixed32", "repeated_fixed64", "repeated_sfixed32", "repeated_sfixed64", "repeated_float", "repeated_double", "repeated_bool", "repeated_string", "repeated_bytes", "repeated_message", "repeated_enum", "oneof_int32", "oneof_int64", "oneof_uint32", "oneof_uint64", "oneof_sint32", "oneof_sint64", "oneof_fixed32", "oneof_fixed64", "oneof_sfixed32", "oneof_sfixed64", "oneof_float", "oneof_double", "oneof_bool", "oneof_string", "oneof_bytes", "oneof_message", "oneof_enum", "map_int32_int32", "map_int64_int64", "map_uint32_uint32", "map_uint64_uint64", "map_sint32_sint32", "map_sint64_sint64", "map_fixed32_fixed32", "map_fixed64_fixed64", "map_sfixed32_sfixed32", "map_sfixed64_sfixed64", "map_int32_float", "map_int32_double", "map_bool_bool", "map_string_string", "map_string_bytes", "map_string_message", "map_int32_bytes", "map_int32_enum", "map_int32_message")
    class Enum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        FOO: _ClassVar[Message3.Enum]
        BAR: _ClassVar[Message3.Enum]
        BAZ: _ClassVar[Message3.Enum]
        EXTRA_3: _ClassVar[Message3.Enum]
    FOO: Message3.Enum
    BAR: Message3.Enum
    BAZ: Message3.Enum
    EXTRA_3: Message3.Enum
    ...
    class MapStringMessageEntry(_message.Message):
        ...
        key: str
        value: Message3
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[Message3, _Mapping]] = ...) -> None: ...
    ...
    class MapInt32EnumEntry(_message.Message):
        ...
        key: int
        value: Message3.Enum
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[Message3.Enum, str]] = ...) -> None: ...
    class MapInt32MessageEntry(_message.Message):
        ...
        key: int
        value: Message3
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[Message3, _Mapping]] = ...) -> None: ...
    ...
    optional_message: Message3
    optional_enum: Message3.Enum
    ...
    repeated_message: _containers.RepeatedCompositeFieldContainer[Message3]
    repeated_enum: _containers.RepeatedScalarFieldContainer[Message3.Enum]
    oneof_int32: int
    oneof_int64: int
    oneof_uint32: int
    oneof_uint64: int
    ...
    oneof_string: str
    oneof_bytes: bytes
    oneof_message: Message3
    oneof_enum: Message3.Enum
    ...
    map_string_message: _containers.MessageMap[str, Message3]
    map_int32_bytes: _containers.ScalarMap[int, bytes]
    map_int32_enum: _containers.ScalarMap[int, Message3.Enum]
    map_int32_message: _containers.MessageMap[int, Message3]
    def __init__(self, optional_int32: _Optional[int] = ..., optional_int64: _Optional[int] = ..., optional_uint32: _Optional[int] = ..., optional_uint64: _Optional[int] = ..., optional_sint32: _Optional[int] = ..., optional_sint64: _Optional[int] = ..., optional_fixed32: _Optional[int] = ..., optional_fixed64: _Optional[int] = ..., optional_sfixed32: _Optional[int] = ..., optional_sfixed64: _Optional[int] = ..., optional_float: _Optional[float] = ..., optional_double: _Optional[float] = ..., optional_bool: bool = ..., optional_string: _Optional[str] = ..., optional_bytes: _Optional[bytes] = ..., optional_message: _Optional[_Union[Message3, _Mapping]] = ..., optional_enum: _Optional[_Union[Message3.Enum, str]] = ..., repeated_int32: _Optional[_Iterable[int]] = ..., repeated_int64: _Optional[_Iterable[int]] = ..., repeated_uint32: _Optional[_Iterable[int]] = ..., repeated_uint64: _Optional[_Iterable[int]] = ..., repeated_sint32: _Optional[_Iterable[int]] = ..., repeated_sint64: _Optional[_Iterable[int]] = ..., repeated_fixed32: _Optional[_Iterable[int]] = ..., repeated_fixed64: _Optional[_Iterable[int]] = ..., repeated_sfixed32: _Optional[_Iterable[int]] = ..., repeated_sfixed64: _Optional[_Iterable[int]] = ..., repeated_float: _Optional[_Iterable[float]] = ..., repeated_double: _Optional[_Iterable[float]] = ..., repeated_bool: _Optional[_Iterable[bool]] = ..., repeated_string: _Optional[_Iterable[str]] = ..., repeated_bytes: _Optional[_Iterable[bytes]] = ..., repeated_message: _Optional[_Iterable[_Union[Message3, _Mapping]]] = ..., repeated_enum: _Optional[_Iterable[_Union[Message3.Enum, str]]] = ..., oneof_int32: _Optional[int] = ..., oneof_int64: _Optional[int] = ..., oneof_uint32: _Optional[int] = ..., oneof_uint64: _Optional[int] = ..., oneof_sint32: _Optional[int] = ..., oneof_sint64: _Optional[int] = ..., oneof_fixed32: _Optional[int] = ..., oneof_fixed64: _Optional[int] = ..., oneof_sfixed32: _Optional[int] = ..., oneof_sfixed64: _Optional[int] = ..., oneof_float: _Optional[float] = ..., oneof_double: _Optional[float] = ..., oneof_bool: bool = ..., oneof_string: _Optional[str] = ..., oneof_bytes: _Optional[bytes] = ..., oneof_message: _Optional[_Union[Message3, _Mapping]] = ..., oneof_enum: _Optional[_Union[Message3.Enum, str]] = ..., map_int32_int32: _Optional[_Mapping[int, int]] = ..., map_int64_int64: _Optional[_Mapping[int, int]] = ..., map_uint32_uint32: _Optional[_Mapping[int, int]] = ..., map_uint64_uint64: _Optional[_Mapping[int, int]] = ..., map_sint32_sint32: _Optional[_Mapping[int, int]] = ..., map_sint64_sint64: _Optional[_Mapping[int, int]] = ..., map_fixed32_fixed32: _Optional[_Mapping[int, int]] = ..., map_fixed64_fixed64: _Optional[_Mapping[int, int]] = ..., map_sfixed32_sfixed32: _Optional[_Mapping[int, int]] = ..., map_sfixed64_sfixed64: _Optional[_Mapping[int, int]] = ..., map_int32_float: _Optional[_Mapping[int, float]] = ..., map_int32_double: _Optional[_Mapping[int, float]] = ..., map_bool_bool: _Optional[_Mapping[bool, bool]] = ..., map_string_string: _Optional[_Mapping[str, str]] = ..., map_string_bytes: _Optional[_Mapping[str, bytes]] = ..., map_string_message: _Optional[_Mapping[str, Message3]] = ..., map_int32_bytes: _Optional[_Mapping[int, bytes]] = ..., map_int32_enum: _Optional[_Mapping[int, Message3.Enum]] = ..., map_int32_message: _Optional[_Mapping[int, Message3]] = ...) -> None: ...
