...
class ComplexOptionType1(_message.Message):
    ...
    foo2: int
    foo3: int
    def __init__(self, foo: _Optional[int] = ..., foo2: _Optional[int] = ..., foo3: _Optional[int] = ...) -> None: ...

class ComplexOptionType2(_message.Message):
    __slots__ = ("bar", "baz", "fred")
    Extensions: _python_message._ExtensionDict
    ...
    def __init__(self, bar: _Optional[_Union[ComplexOptionType1, _Mapping]] = ..., baz: _Optional[int] = ..., fred: _Optional[_Union[ComplexOptionType2.ComplexOptionType4, _Mapping]] = ...) -> None: ...

class ComplexOptionType3(_message.Message):
    __slots__ = ("qux", "complexoptiontype5")
    ...
    def __init__(self, qux: _Optional[int] = ..., complexoptiontype5: _Optional[_Union[ComplexOptionType3.ComplexOptionType5, _Mapping]] = ...) -> None: ...
...
class Aggregate(_message.Message):
    ...
    def __init__(self, i: _Optional[int] = ..., s: _Optional[str] = ..., sub: _Optional[_Union[Aggregate, _Mapping]] = ..., file: _Optional[_Union[_descriptor_pb2.FileOptions, _Mapping]] = ..., mset: _Optional[_Union[AggregateMessageSet, _Mapping]] = ...) -> None: ...
