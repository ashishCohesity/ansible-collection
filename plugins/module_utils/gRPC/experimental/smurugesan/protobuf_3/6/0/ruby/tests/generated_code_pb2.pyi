...
class TestUnknown(_message.Message):
    __slots__ = ("optional_unknown", "repeated_unknown", "oneof_unknown", "map_unknown", "unknown_field")
    class MapUnknownEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        value: TestUnknown
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[TestUnknown, _Mapping]] = ...) -> None: ...
    OPTIONAL_UNKNOWN_FIELD_NUMBER: _ClassVar[int]
    REPEATED_UNKNOWN_FIELD_NUMBER: _ClassVar[int]
    ONEOF_UNKNOWN_FIELD_NUMBER: _ClassVar[int]
    MAP_UNKNOWN_FIELD_NUMBER: _ClassVar[int]
    UNKNOWN_FIELD_FIELD_NUMBER: _ClassVar[int]
    optional_unknown: TestUnknown
    repeated_unknown: _containers.RepeatedCompositeFieldContainer[TestUnknown]
    oneof_unknown: TestUnknown
    map_unknown: _containers.MessageMap[str, TestUnknown]
    unknown_field: int
    def __init__(self, optional_unknown: _Optional[_Union[TestUnknown, _Mapping]] = ..., repeated_unknown: _Optional[_Iterable[_Union[TestUnknown, _Mapping]]] = ..., oneof_unknown: _Optional[_Union[TestUnknown, _Mapping]] = ..., map_unknown: _Optional[_Mapping[str, TestUnknown]] = ..., unknown_field: _Optional[int] = ...) -> None: ...
