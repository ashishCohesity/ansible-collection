...
class TestAny(_message.Message):
    __slots__ = ("int32_value", "any_value", "repeated_any_value")
    ...
    def __init__(self, int32_value: _Optional[int] = ..., any_value: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., repeated_any_value: _Optional[_Iterable[_Union[_any_pb2.Any, _Mapping]]] = ...) -> None: ...
