...
class FieldDescriptorProto(_message.Message):
    __slots__ = ("name", "number", "label", "type", "type_name", "extendee", "default_value", "oneof_index", "json_name", "options")
...
class FieldOptions(_message.Message):
    __slots__ = ("ctype", "packed", "jstype", "lazy", "deprecated", "weak", "uninterpreted_option")
    Extensions: _python_message._ExtensionDict
