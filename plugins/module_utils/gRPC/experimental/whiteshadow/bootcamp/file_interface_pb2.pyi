...
class WriteFileRangeReply(_message.Message):
    __slots__ = ("error",)
    ERROR_FIELD_NUMBER: _ClassVar[int]
    error: str
    def __init__(self, error: _Optional[str] = ...) -> None: ...
...
class ReadFileRangeReply(_message.Message):
    __slots__ = ("content", "error", "eof")
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ...
    error: str
    eof: bool
    def __init__(self, content: _Optional[bytes] = ..., error: _Optional[str] = ..., eof: bool = ...) -> None: ...
