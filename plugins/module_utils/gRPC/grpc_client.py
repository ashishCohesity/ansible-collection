# plugins/modules/grpc_client/grpc_client.py

import grpc
import base64
import json
# Update the import paths to be relative
from .magneto.agents.stub.agent_param_pb2 import (
    GetAgentInfoArg, GetGFlagSettingsArg, UpdateGFlagSettingsArg, ListFilesArg,
    FetchFilesArg, WriteFileArg, RunDiagnosticsArg
)
from .magneto.storage_proxy.stub.rpc_args_pb2 import (
    GetRootMetadataArg, WriteFileDataArg, CreateRestoreFilesArg, ProxyBaseArg
)
from .magneto.storage_proxy.stub.grpc_service_pb2_grpc import GRpcServiceStub
from .magneto.agents.stub.agent_rpc_pb2_grpc import AgentRpcServiceStub
