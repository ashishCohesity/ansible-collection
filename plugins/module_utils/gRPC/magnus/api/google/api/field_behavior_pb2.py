...
# source: magnus/api/google/api/field_behavior.proto
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FIELDBEHAVIOR']._serialized_start=93
  _globals['_FIELDBEHAVIOR']._serialized_end=259
