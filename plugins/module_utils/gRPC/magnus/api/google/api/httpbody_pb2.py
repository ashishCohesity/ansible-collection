...
# source: magnus/api/google/api/httpbody.proto
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HTTPBODY']._serialized_start=79
  _globals['_HTTPBODY']._serialized_end=167
