...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in pigeon/stub/grpc_service_pb2_grpc.py depends on'
...
class GRpcServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.QueryRemoteClusterInfo = channel.unary_unary(
                '/cohesity.pigeon.stub.GRpcService/QueryRemoteClusterInfo',
        ...
        self.RemoteRequest = channel.unary_unary(
                '/cohesity.pigeon.stub.GRpcService/RemoteRequest',
...
def add_GRpcServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cohesity.pigeon.stub.GRpcService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cohesity.pigeon.stub.GRpcService', rpc_method_handlers)
