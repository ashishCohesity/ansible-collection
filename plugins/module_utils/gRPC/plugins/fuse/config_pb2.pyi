...
class FuseCertificateProto(_message.Message):
    ...
    connection_config_vec: _containers.RepeatedCompositeFieldContainer[FuseCertificateProto.ConnectionConfig]
    def __init__(self, connection_config_vec: _Optional[_Iterable[_Union[FuseCertificateProto.ConnectionConfig, _Mapping]]] = ...) -> None: ...
