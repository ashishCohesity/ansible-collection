...
class SbtCertificateProto(_message.Message):
    ...
    connection_config_vec: _containers.RepeatedCompositeFieldContainer[SbtCertificateProto.ConnectionConfig]
    def __init__(self, connection_config_vec: _Optional[_Iterable[_Union[SbtCertificateProto.ConnectionConfig, _Mapping]]] = ...) -> None: ...
