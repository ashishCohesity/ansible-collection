...
class ErrorProto(_message.Message):
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        kInvalidSchema: _ClassVar[ErrorProto.Type]
        kRequestError: _ClassVar[ErrorProto.Type]
        kNonExistent: _ClassVar[ErrorProto.Type]
        kAlreadyExist: _ClassVar[ErrorProto.Type]
        kNonExistentSchema: _ClassVar[ErrorProto.Type]
        kNonExistentCounter: _ClassVar[ErrorProto.Type]
        kPulseUpdateError: _ClassVar[ErrorProto.Type]
    ...
    kInvalidSchema: ErrorProto.Type
    kRequestError: ErrorProto.Type
    kNonExistent: ErrorProto.Type
    kAlreadyExist: ErrorProto.Type
    kNonExistentSchema: ErrorProto.Type
    kNonExistentCounter: ErrorProto.Type
    kPulseUpdateError: ErrorProto.Type
