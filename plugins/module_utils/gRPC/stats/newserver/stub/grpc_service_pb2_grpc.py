...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in stats/newserver/stub/grpc_service_pb2_grpc.py depends on'
...
class GrpcServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateTask = channel.unary_unary(
                '/cohesity.stats.newserver.stub.GrpcService/CreateTask',
        ...
        self.ReportTaskProgress = channel.unary_unary(
                '/cohesity.stats.newserver.stub.GrpcService/ReportTaskProgress',
        ...
        self.GetTasks = channel.unary_unary(
                '/cohesity.stats.newserver.stub.GrpcService/GetTasks',
...
def add_GrpcServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cohesity.stats.newserver.stub.GrpcService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cohesity.stats.newserver.stub.GrpcService', rpc_method_handlers)
