...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in stats/server/stub/rpc_service_pb2_grpc.py depends on'
...
class RpcServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMaster = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetMaster',
        ...
        self.CreateOrUpdateEntitySchema = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/CreateOrUpdateEntitySchema',
        ...
        self.GetEntitiesSchema = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetEntitiesSchema',
        ...
        self.AddOrUpdateEntity = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/AddOrUpdateEntity',
        ...
        self.GetEntities = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetEntities',
        ...
        self.NewGetEntities = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/NewGetEntities',
                request_serializer=stats_dot_base_dot_stats__pb2.GetEntitiesArg.SerializeToString,
                response_deserializer=stats_dot_base_dot_stats__pb2.GetEntitiesResult.FromString,
                _registered_method=True)
        self.GetEntitiesById = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetEntitiesById',
        ...
        self.NewGetEntitiesById = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/NewGetEntitiesById',
                request_serializer=stats_dot_base_dot_stats__pb2.GetEntitiesByIdArg.SerializeToString,
                response_deserializer=stats_dot_base_dot_stats__pb2.GetEntitiesByIdResult.FromString,
                _registered_method=True)
        self.DeleteEntity = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/DeleteEntity',
        ...
        self.DeleteClusterInstance = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/DeleteClusterInstance',
        ...
        self.AddEntityStats = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/AddEntityStats',
        ...
        self.AddEntitiesStats = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/AddEntitiesStats',
        ...
        self.GetTimeSeriesStats = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetTimeSeriesStats',
        ...
        self.CreateCounters = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/CreateCounters',
        ...
        self.GetCounters = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetCounters',
        ...
        self.UpdateCounters = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/UpdateCounters',
        ...
        self.DeleteCounters = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/DeleteCounters',
        ...
        self.CreateStatsContainers = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/CreateStatsContainers',
        ...
        self.GetStatsContainers = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetStatsContainers',
        ...
        self.UpdateStatsContainers = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/UpdateStatsContainers',
        ...
        self.DeleteStatsContainers = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/DeleteStatsContainers',
        ...
        self.GetAlertPolicies = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetAlertPolicies',
        ...
        self.UpdateAlertPolicies = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/UpdateAlertPolicies',
        ...
        self.GetEntityMetadata = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetEntityMetadata',
        ...
        self.CreateTask = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/CreateTask',
        ...
        self.ReportTaskProgress = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/ReportTaskProgress',
        ...
        self.GetTasks = channel.unary_unary(
                '/cohesity.stats.server.stub.RpcService/GetTasks',
...
class RpcServiceServicer(object):
    ...
    def GetMaster(self, request, context):
        """Message sent to get the current Stats master.
        """
...
def add_RpcServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cohesity.stats.server.stub.RpcService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cohesity.stats.server.stub.RpcService', rpc_method_handlers)
