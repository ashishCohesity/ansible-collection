# plugins/modules/grpc_client.py
...
from grpc_client.magneto.agents.stub.agent_param_pb2 import (
    GetAgentInfoArg, GetGFlagSettingsArg, UpdateGFlagSettingsArg, ListFilesArg,
    FetchFilesArg, WriteFileArg, RunDiagnosticsArg
)
from grpc_client.magneto.storage_proxy.stub.rpc_args_pb2 import (
    GetRootMetadataArg, WriteFileDataArg, CreateRestoreFilesArg, ProxyBaseArg
)
from grpc_client.magneto.storage_proxy.stub.grpc_service_pb2_grpc import GRpcServiceStub
from grpc_client.magneto.agents.stub.agent_rpc_pb2_grpc import AgentRpcServiceStub
from grpc_client.magneto.agents.stub.agent_base_pb2 import AgentBaseArg
